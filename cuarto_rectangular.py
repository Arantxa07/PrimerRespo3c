# Este programa calcula el area de n cuarto rectangular y muestra el resultado en el sistema métrico (metros cuadrados) y en sistema imperial (pies cuadrados)
# 1. Inicio
